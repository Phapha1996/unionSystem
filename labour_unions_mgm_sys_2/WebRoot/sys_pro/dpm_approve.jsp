...
<script type="text/javascript" charset="UTF-8">
	...
	var mbName_consult ='<%=user.getMember().getName()%>';

	var dpm_consult='<%=user.getMember().getDpmBrief()%>';
</script>
<script type="text/javascript" src="../script/sys_pro_dpm_approve.js"></script>
