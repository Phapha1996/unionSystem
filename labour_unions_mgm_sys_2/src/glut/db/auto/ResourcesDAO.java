 ...
 * 
 * @see glut.db.auto.Resources
 * @author MyEclipse Persistence Tools
 */
@Transactional
public class ResourcesDAO {
	private static final Logger log = LoggerFactory
			.getLogger(ResourcesDAO.class);
	// property constants
	...
	public Resources findById(java.lang.Integer id) {
		...
		try {
			Resources instance = (Resources) getCurrentSession().get(
					"glut.db.auto.Resources", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Resources instance) {
		...
		try {
			List results = getCurrentSession()
					.createCriteria("glut.db.auto.Resources")
	...
	public Resources merge(Resources detachedInstance) {
		...
		try {
			Resources result = (Resources) getCurrentSession().merge(
					detachedInstance);
